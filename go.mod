module github.com/digimaks/api-audit
...
require (
	...
	azugo.io/opentelemetry v0.39.0
	github.com/digimaks/go-idauth v1.2.1-1
	github.com/lafriks-fork/goas v1.16.2
	github.com/lx-lib/go-openapi v0.6.2-1
	github.com/lx-lib/lx-go-jsondb v0.10.12-2
	github.com/nobid-lsp-latvia/go-audit v1.2.0
